...
Control role: This is the detailed primary control for semantic ingestion of user-supplied images and visual inputs. It complements, but does not replace, universal intake, CCS routing, integrity/materiality, security/privacy, or other independent hard gates.
...
| CCS / ACS | orchestration, visibility, routing, handoffs, and state synchronization | permission to bypass source inspection or validation |
